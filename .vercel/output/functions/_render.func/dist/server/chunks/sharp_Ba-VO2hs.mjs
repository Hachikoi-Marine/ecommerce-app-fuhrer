import { A as AstroError, bg as MissingSharp } from './sequence_BMZP2NkZ.mjs';
import { b as baseService, p as parseQuality } from './generic_BYzr7-y8.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_BUE0NLpF.mjs').then(n => n.i)).default;
  } catch {
